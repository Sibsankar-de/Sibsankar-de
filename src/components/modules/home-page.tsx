      ...
      <main>
        ...
        <section className="overflow-hidden border-b-2 border-line">
          <div className="mx-auto grid max-w-7xl lg:grid-cols-[1.1fr_0.9fr]">
            ...
            <div className="relative min-h-[640px] overflow-hidden border-t-2 border-line bg-primary lg:min-h-105 lg:overflow-visible lg:border-t-0 lg:border-l-2">
        ...
        <section className="mx-auto grid max-w-7xl border-x-0 border-line px-5 py-14 sm:px-8 sm:py-20 lg:grid-cols-3 lg:border-x-2">
          ...
          <RevealBlock className="col-span-2" delay={0.1}>
            <p className="mt-4 max-w-3xl text-2xl font-medium leading-tight sm:text-4xl lg:mt-0">
              {profile.summary}
            </p>
          </RevealBlock>
        </section>
        ...
        <section className="mx-auto max-w-7xl px-5 py-14 sm:px-8 sm:py-20" id="toolbox">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <RevealStagger className="h-full" staggerDelay={0.08}>
              {Object.entries(skills).map(([group, items]) => (
                <div
                  className="h-full border-2 border-line bg-surface p-6 shadow-[5px_5px_0_var(--line)] transition-all hover:-translate-y-1 hover:shadow-[7px_7px_0_var(--line)]"
                  key={group}
                >
          ...
          <div className="mx-auto max-w-7xl px-5 py-14 sm:px-8 sm:py-20">
            ...
            <div className="grid gap-8 lg:grid-cols-[1.1fr_1.9fr]">
              ...
              <div className="space-y-4">
                <RevealStagger direction="left" staggerDelay={0.07}>
